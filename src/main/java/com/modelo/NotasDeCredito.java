...
public class NotasDeCredito extends Incrementable4 {
	
	@Column(length = 6)
	@DefaultValueCalculator(CalculadorConsecutivo3.class) // Año actual	//@ReadOnly // El usuario no puede modificar el valor
	@ReadOnly
	@SearchKey
	int numero;
    ...
    @ListProperties(
            ...
            "importe+[" +
            	"notadecredito.porcentajeIVA," +
            	"notadecredito.iva," +
            	"notadecredito.importeTotal" +
            "]" 
        )	
